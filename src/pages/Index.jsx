import { Box, Container, Heading, Text, VStack, HStack, Button, Icon, SimpleGrid } from "@chakra-ui/react";
  ...
  return (
    <Container maxW="container.xl" p={4}>
      <VStack spacing={8} as="section" textAlign="center">
        <Carousel images={["https://images.unsplash.com/photo-1583466478015-2dce6bf2f551?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHx0cmFkaXRpb25hbCUyMGNoaW5lc2UlMjBtZWRpY2luZXxlbnwwfHx8fDE3MDkxMTM4MTB8MA&ixlib=rb-4.0.3&q=80&w=1080", "https://via.placeholder.com/1080", "https://via.placeholder.com/1080"]} mt={5} />
